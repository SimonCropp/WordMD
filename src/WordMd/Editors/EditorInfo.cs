...
{
    static EditorInfo VSCode { get; } = new(
        "vscode",
        "Visual Studio Code",
        "code",
        "\"{0}\"",
    ...
    static EditorInfo Rider { get; } = new(
        "rider",
        "JetBrains Rider",
        "rider64.exe",
        "\"{0}\"",
    ...
    static EditorInfo Notepad { get; } = new(
        "notepad",
        "Notepad++",
        "notepad++.exe",
        "\"{0}\"",
    ...
    static EditorInfo Typora { get; } = new(
        "typora",
        "Typora",
        "typora.exe",
        "\"{0}\"",
    ...
    static EditorInfo Obsidian { get; } = new(
        "obsidian",
        "Obsidian",
        "obsidian.exe",
        "\"{0}\"",
